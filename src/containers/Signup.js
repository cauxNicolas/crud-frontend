            ...
            <form id="signup" onSubmit={handleSubmit}>
                ...
                <div className="flex">
                    <div>
                        ...
                        />
                        {errorName && (
                            <p className="error">merci de remplir le nom</p>
                        )}
                    </div>
                    <div>
                        <Input
                            ...
                            className={
                                errorLastname === true ? "errorInput" : null
                            }
                        />
                        {errorLastname && (
                ...
                />
                {errorEmail && (
                    <p className="error">merci de remplir l'email</p>
                )}
                ...
                />
                {errorTextarea && (
                    <p className="error">merci de remplir le champ</p>
                )}
                ...
                <div className="flex">
                    <div>
                        ...
                        {errorPassword && (
                            <p className="error">
                                merci de remplir le mot de passe
                            </p>
                        )}
                        {passwordEgalConfirm && (
                            <p className="error">
                        ...
                        {passwordLength && (
                            <p className="error">Minimum 5 lettres</p>
                        )}
                    </div>
                    <div>
                        <Input
                        ...
                        {errorConfirmPassword && (
                            <p className="error">
                                merci de remplir la confirmation
                            </p>
                        )}
